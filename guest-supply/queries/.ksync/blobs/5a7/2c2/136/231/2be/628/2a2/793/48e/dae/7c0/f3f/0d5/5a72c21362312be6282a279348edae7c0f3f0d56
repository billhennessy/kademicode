...
function doTransformRow(row, params, rowContext, importContext){
  //TODO: Skip records for properties with pending-property tag
  //TODO: If ordernumber exists, reset points and delete before inserting
 ...
 * @param {*} freight 
 * @returns 
 * Subtracts frieght and (potentially) other values from the Sale amount.
 */
...
//TODO: Skip records without matching salesBy record in invoice-data
//TODO: If ordernumber and orderline already exists, reset points and delete before inserting
